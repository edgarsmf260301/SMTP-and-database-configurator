...
const UserRegisterModal: React.FC<UserRegisterModalProps> = ({
  ...
  const handleRegister = async (e: any) => {
    ...
    if (form.roles.includes('admin')) {
      setError(
        'Para registrar un administrador, primero debes verificar el correo electrónico.'
      );
      setSaving(false);
      return;
    }
    ...
    try {
      ...
      if (res.ok) {
        ...
        setTimeout(() => {
          ...
          setAdminVerificationError('');
          setAdminVerificationExpired(false);
          if (adminCodeTimerRef.current)
            clearTimeout(adminCodeTimerRef.current);
          onUserRegistered();
          setSuccess(false);
        }, 1500);
      } else {
      ...
      >
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="relative min-h-[0px] flex flex-col items-center justify-center">
            ...
            {success && (
              <div className="text-green-400 text-center font-bold animate-fade-in mt-2">
